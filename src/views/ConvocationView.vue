            ...
            <!-- The main content -->
             <div class=" h-full pl-12 pt-9">
                <div class="heroImg flex justify-center pt-11 pb-9">
                    <div>
                        <p class=" text-white font-bold text-xl sm:text-5xl font-playfair text-center ">Convocations</p>
                        <p class=" text-center pt-4 text-white font-poltawski text-sm">Vous êtes tenu(e) de signer les convocations énumérées ci-dessous.</p>
                    </div>
                </div>
                <div class="" v-if="dataLoaded">
                    ...
                    <div class="my-10 group flex items-center">
                     ...
                     <p class=" text-2xl py-2 text-blue-700 font-quicksand font-semibold mx-4 cursor-pointer">Listes des convocations </p>
                    </div>
...
import { accessToken_state, isUserAuth,getNoneSignedConvo,countNoneSignedAuth } from '../Services/service'
...
import { gsap } from 'gsap'
        ...
        onMounted(async () => {
            ...
            if (response == true) {
                ...
                autorisations.value = await getNoneSignedConvo()
...
let apllySignature=async()=>{
  ...
  .call(async ()=>{
   ...
   presidentService.signeeConvocation(form,selectedOne.value,router);
  })
  }
else {
    gsap.timeline()
