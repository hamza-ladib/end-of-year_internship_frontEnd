            ...
            <div class=" h-full pl-12 pt-9 relative ">
                <div class="heroImg flex justify-center pt-11 pb-9">
                    <div>
                        ...
                        <p class=" text-center pt-4 text-white font-poltawski text-sm">Ci-dessous, vous trouverez toutes les demandes auxquelles vous devez ajouter un dossier de recolement.</p>
                    </div>
                </div>
                            ...
                            <div class=" border-2 border-gray-400 rounded-md  hover:drop-shadow-2xl bg-white"
                                ...
                                <div class=" my-1 flex justify-center drop-shadow-lg cursor-pointer"
                                    ...
                                    <div class="  flex items-center rounded-md overflow-hidden">
                                        <p class=" bg-blue-700  px-4 py-2 font-bold text-white">Ajouter le dossier</p>
...
import { accessToken_state, isUserAuth, getAuthorisedDemandeService } from '../Services/service'
    ...
    setup() {
        ...
        onMounted(async () => {
            ...
            if (response == true) {
                ...
                demandes.value = await getAuthorisedDemandeService({ userId: user.value.id });
        ...
        const gotoPage = async(id)=> {
            ...
            await router.push('/addDossierRocolement/' + encodedId)
        }
