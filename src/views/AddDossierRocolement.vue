        ...
        <div class="">
            ...
            <div class=" h-full pl-12 pt-9">
                <div class="heroImg flex justify-center pt-11 pb-9">
                    <div>
                        <p class=" text-white font-bold text-xl sm:text-5xl font-playfair text-center">Dossier de recolement</p>
                        <p class=" text-center pt-4 text-white font-poltawski text-sm">Nous vous prions d'inclure le dossier de recolement pour cette demande.</p>
                    </div>
                    ...
                    <div class="mt-9">
                        ...
                        <transition name="fade">
                            <div class=" bg-green-800 rounded-lg  flex justify-between items-center mt-4 px-4 mx-24 py-6 border-green-400 border-2"
                                ...
                                <p class="text-green-400 font-bold text-lg">
                                    Votre dossier de recolement a été ajouté avec succès.</p>
                        ...
                        <transition name="fade">
                            <div class=" mt-9  mx-12 bg-gray-300 pt-8 rounded-md" v-if="showPopUp">
                                <p class=" font-bold text-lg text-center text-gray-700">Vous êtes sur le point d'ajouter ce dossier comme un dossier de recolement, êtes-vous d'accord ?</p>
                        ...
                        <transition name="fade">
                            <div class=" mt-9" v-if="toggleForm">
                                <p class=" text-lg font-playfair mx-4 pr-1 w-fit relative group ">Il est temps d'ajouter
                                    le dossier de recolement pour la demande en cours
                                <p
                                ...
                                <div class=" py-6">
                                    <form enctype="multipart/form-data" @submit.prevent="submitForm" class=" grid">
                                        <label class=" font-poppins text-base  md:text-lg ">Le dossier à inclure :</label>
                                        <input type="file"
...
import { accessToken_state, isUserAuth, getSingleDemande, sendDossierRecolement } from '../Services/service'
    ...
    // function to grap the files from the input 
      const onFileInputChange = (event) => {
        ...
        const sendData = async () => {
            ...
            const response = await sendDossierRecolement(form)
            if (response.state) {
